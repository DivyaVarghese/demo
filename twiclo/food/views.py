...
def index(request):
	...
	send_mail('gfhj','fcgvhb','divyacogniz@gmail.com',['divyavarghese0404@gmail.com'])
...
def whotel(request):
	if request.method=='POST':
		...
		e2=list(e1)
		e3=e2[0][0]
		co='the food will deliver to you in'+e3
		# send_mail('the food order taken by restuarnt',co,)
		...
		r5=r3.orderid
		r55=Order.objects.get(orderid=r5)
		r3.status=1
		r3.save()
		print(r1,r2,r3)
		...
		print(r4)
		r4.delete()
		r6=Rate.objects.get(orderid=r55)
		print(r6)
		r6.time=e3
		r6.save()
		print(r6,e3)
...
def rating(request):
	if request.method=='POST':
		...
		print(oid)
		t=Rate.objects.get(orderid=oid)
		t1.rating=rat
		t1.save()
		t2=HotelReg.objects.get(hid=hid)
		t2.rating=rat
		t2.save()


		
		return render(request,'wcustomer.html',{})
	else:
		...
		r2=CustomerR.objects.get(user1=r1)
		r3=r2.cid
		e=Rate.objects.filter(customerid=r3)
		l=[]
		l1=[]
		l2=[]
		for x in e:
			...
			if oo=='':
				...
				u9=u7+(u8/60)+u6
				print(u9)
				u10=datetime.datetime.now().hour
				u11=datetime.datetime.now().minute
				u12=u10+(u11/60)
				print(u12)
				if float(u12)>=u9:
					u13=1
					...
					u13=0
		print('jhbjh')
		return render(request,'wcustomer.html',{'u3':u3,'u2':u2,'u4':u4,'u13':u13})
